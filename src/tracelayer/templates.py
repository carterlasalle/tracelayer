...
_TEMPLATES: dict[str, dict] = {
    ...
    "requirement": {
        ...
        "required": ["statement"],
        "states": ["UNIMPLEMENTED", "PARTIALLY_IMPLEMENTED", "IMPLEMENTED", "VERIFIED",
                   "STALE", "DEPRECATED"],
        "relationships": ["derived_from", "supersedes", "addresses"],
    },
    "spec": {
        "sections": ["summary", "problem", "context", "goals", "non-goals",
                     "intended behavior", "requirements", "interfaces", "test strategy",
                     "open questions"],
    ...
    "rfc": {
        "sections": ["status", "summary", "problem", "motivation", "proposed design",
                     "interfaces", "failure modes", "alternatives", "compatibility",
    ...
    "adr": {
        "sections": ["status", "context", "decision", "alternatives considered",
                     "consequences", "operational implications", "related requirements"],
    ...
    "plan": {
        "sections": ["objective", "scope", "phases", "tasks", "dependencies",
                     "acceptance", "questions", "current state"],
    ...
    "incident": {
        "sections": ["summary", "impact", "timeline", "root cause", "remediation",
                     "follow-up"],
