...
_SEMANTIC: list[tuple[str, str, str]] = [
    ("work", "source was produced or authorized by the target work item",
    ...
    ("implements", "source realizes target plan or decision",
     "implementation/config -> plan/decision"),
    ("verifies", "source test or evidence verifies target contract", "test -> requirement"),
    ("exercises", "source test intends to execute target implementation",
     "test -> implementation"),
    ...
    ("depends_on", "semantic dependency beyond trivial inferred calls",
